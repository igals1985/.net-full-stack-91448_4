...
cinema1.morningShift.cashierArr = new Array<Cashier>(
    new Cashier(21, cinema1.cinemaName,"Bob"),
    new Cashier(23, cinema1.cinemaName, "Alice"),
    new Cashier(27, cinema1.cinemaName, "Clarc")
);
...
cinema1.nightShift.cashierArr = new Array<Cashier>(
    new Cashier(21, cinema1.cinemaName, "Anna"),
    new Cashier(23, cinema1.cinemaName, "Netanel"),
    new Cashier(27, cinema1.cinemaName, "Boris"),
    new Cashier(27, cinema1.cinemaName, "Yaniv")
);
...
let cinemaAgency: CinemaAgency = new CinemaAgency();
