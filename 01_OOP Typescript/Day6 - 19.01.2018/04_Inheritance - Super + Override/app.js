...
var B = (function (_super) {
    ...
    B.prototype.only_in_A_B = function () {
        ...
        var str = _super.prototype.only_in_A_B.call(this); //str= "A in only_in_A_B"
        return str + "  & B in only_in_A_B";
    };
    B.prototype.only_in_A_B_C = function () {
        //super - is a keyword that refers to the base class (in this case "super" is A)
        var str = _super.prototype.only_in_A_B.call(this); //str= "A in only_in_A_B_C"
...
var C = (function (_super) {
    ...
    C.prototype.only_in_A_B_C = function () {
        ...
        var str = _super.prototype.only_in_A_B_C.call(this); //str= "A in only_in_A_B_C & B in only_in_A_B_C"
